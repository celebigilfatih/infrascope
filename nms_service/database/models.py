...
class Device(Base):
    ...
    snmp_v3_security_level = Column(String(32), nullable=True)
    snmp_v3_auth_protocol = Column(String(32), nullable=True)
    snmp_v3_auth_password = Column(Text, nullable=True)
    snmp_v3_privacy_protocol = Column(String(32), nullable=True)
    snmp_v3_privacy_password = Column(Text, nullable=True)
    ssh_username = Column(String(255), nullable=True)
    ssh_password = Column(String(255), nullable=True)
    ssh_port = Column(Integer, default=22)
    ssh_host_key_algorithm = Column(String(64), nullable=True)
    ssh_host_key_fingerprint = Column(String(128), nullable=True)
